...
------------------------------------------------
-- Custom User Rules & Scratchpads
------------------------------------------------

-- Tk Rules
hl.window_rule({ match = { class = "^(Tk)$" }, float = true, no_blur = true, no_focus = true })

-- Pypr Scratchpad Rules
hl.window_rule({
    match = { class = "^(kitty-dropterm)$" },
    float = true,
    size = "65% 60%",
    move = "17% 6%",
    workspace = "special:scratch_term",
})
hl.window_rule({
    ...
    size = "50% 20%",
    center = true,
    workspace = "special:scratch_music",
})
hl.window_rule({
    ...
    size = "50% 80%",
    center = true,
    workspace = "special:scratch_taskbar",
})

-- QD — Quick Directory Jump
hl.window_rule({
    match = { class = "^(floating_search_qd)$" },
    float = true,
    size = "1200 800",
    center = true,
    stay_focused = true,
...
-- Google Search Popup & Firefox Rules
hl.window_rule({
    match = { class = "^(google-search)$" },
    float = true,
    size = "960 480",
    center = true,
    dim_around = true,
...
hl.window_rule({
    match = { class = "^(firefox.*)$", title = "^(.*\\[POPUP\\].*)$" },
    float = true,
    size = "1200 720",
    center = true,
    suppress_event = "fullscreen maximize",
})
hl.window_rule({ match = { class = "^(firefox.*)$" }, suppress_event = "fullscreen maximize" })
